...
Приложение выполняет роль explorer'а для prometheus. На текущий момент приложение собирает данные по используемым клиентским лицензиям и доступная производительность серверов приложений, сборка осуществляется через утилиту rac.
