...
* Количество сеансов
* Текущая память процесса и загрузка ЦПУ в разрезе процессов ОС
* Общая загрузка ЦПУ (получается из ОС)
* Метрики диска (получается из ОС)
    ...
    * **WriteCount** _(Это значения увеличиваются при завершении запроса ввода-вывода в миллисекундах)_
